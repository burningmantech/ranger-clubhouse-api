...
class MoreHandlesMail extends ClubhouseMailable
{
    ...
    public function envelope(): Envelope
    {
        return new Envelope(
            ...
            subject: 'Hey ' . $this->application->first_name . ', your Ranger Application needs attention!',
        );
    }
    ...
    {
        return new Content(
            view: 'emails.prospective-application.more-handles'
        );
    }
}
