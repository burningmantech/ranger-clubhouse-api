...
class RejectUnqualifiedMail extends ClubhouseMailable
{
    ...
    public function envelope(): Envelope
    {
        return new Envelope(
            ...
            subject: 'Hey ' . $this->application->first_name . ', we found a problem with your Ranger Application',
        );
    }
    ...
    {
        return new Content(
            view: 'emails.prospective-application.reject-unqualified'
        );
    }
}
