...
class ApprovedCallsignMail extends ClubhouseMailable
{
    ...
    public function envelope(): Envelope
    {
        return new Envelope(
            ...
            subject: 'Hey ' . $this->application->first_name . ', your Ranger Radio Handle has been approved!',
        );
    }
    ...
    {
        return new Content(
            view: 'emails.prospective-application.approved-callsign',
        );
    }
}
